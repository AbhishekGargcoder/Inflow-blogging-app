...
export default function VerifyEmail() {
    ...
    useEffect(() => {
        if (status === 'success') {
            // set token to localstorage for all future request yhi token kaam aa jaye
    ...
    return (
        <>
            {/* <Appbar /> */}
            <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,600;1,400&family=Inter:wght@300;400;500;600&family=Lora:ital,wght@0,400;0,500;0,600;1,400&display=swap" rel="stylesheet" />
            <div className="relative min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-rose-50/60 via-stone-50 to-red-50/50 overflow-hidden font-sans px-4 py-12">
                ...
                <div className="absolute top-1/4 -left-32 w-96 h-96 bg-black/10 rounded-full blur-[90px] animate-glow-1 pointer-events-none" />
                <div className="absolute bottom-1/4 -right-32 w-96 h-96 bg-black/10 rounded-full blur-[90px] animate-glow-2 pointer-events-none" />
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-black/10 rounded-full blur-[120px] pointer-events-none" />
                ...
                <div className="relative w-full max-w-md z-10 transition-all duration-300">
                    ...
                    <div className="text-center mb-8">
                        <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-[var(--color-gray-900)] text-white font-bold text-xl shadow-lg shadow-black-500/20 mb-3">
                            ✓
                        </div>
                        <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 m-0">
                            Ink<span className="text-white border-black-900  bg-clip-text text-transparent">Flow</span>
                        </h1>
                        <p className="text-sm text-slate-500 mt-1">Experience the flow of words, streamlined and premium.</p>
                    </div>
                    ...
                    <div className="backdrop-blur-xl bg-white/80 border border-white shadow-2xl shadow-rose-100/50 rounded-2xl p-8 relative overflow-hidden text-center">
                        ...
                        {status === 'loading' && (
                            <div className="flex flex-col items-center py-6 space-y-4">
                                <Loader2 className="w-16 h-16 text-black-600 animate-spin" />
              ...
              >
                ...
                <ArrowRight className="w-4 h-4" />
                        ...
                        {status === 'error' && (
                            <div className="flex flex-col items-center py-6 space-y-4 animate-scale-up">
                                ...
                                <button
                                    ...
                                    className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-[var(--color-gray-900)] hover:from-rose-500 hover:to-red-500 text-white font-semibold rounded-xl shadow-lg shadow-rose-500/15 hover:shadow-black/25 transition duration-200 mt-6 cursor-pointer"
                                >
                        ...
                        <div className="mt-8 text-center text-sm border-t border-slate-100 pt-6">
                            ...
                            <a href={`mailto:${CONTACT_US_EMAIL}`} className="font-bold text-[var(--color-gray-900)] hover:text-black/60 transition duration-200">
                                support@InkFlow.com
                            </a>
                        </div>
                    </div>
